...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/json-jruby-1.2.0-universal-java-1.6/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/json-jruby-1.2.0-universal-java-1.6/lib")
